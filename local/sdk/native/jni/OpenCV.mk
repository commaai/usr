...
OPENCV_MODULES:=contrib stitching nonfree superres ocl videostab photo objdetect legacy video ml calib3d features2d highgui imgproc flann androidcamera core
...
ifeq ($(OPENCV_LIB_TYPE),SHARED)
    ...
    ifeq ($(TARGET_ARCH_ABI),armeabi-v7a)
        ...
        OPENCV_EXTRA_COMPONENTS:=log m dl /data/data/com.termux/files/usr/lib/libz.so
    endif
    ifeq ($(TARGET_ARCH_ABI),arm64-v8a)
        OPENCV_3RDPARTY_COMPONENTS:=libjpeg libpng libtiff libjasper IlmImf
        OPENCV_EXTRA_COMPONENTS:=log m dl /data/data/com.termux/files/usr/lib/libz.so
